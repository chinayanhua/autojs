...
var moduleNameArray = [module_zhifubao, module_shandianhezi, module_qutoutiao,
...
//可以选择的模块
var appNameArray = [appName_zhifubao, appName_shandianhezi, appName_qutoutiao,
...
function mainEntrence() {
    ...
    if (indexOption == (appNameArray.length - 1)) {
        ...
        commonFunction.enterMainPage(appNameArray[indexOption], waitTime);
        moduleNameArray[indexOption].start(commonFunction);
    }else {
        commonFunction.enterMainPage(appNameArray[indexOption], waitTime);
        moduleNameArray[indexOption].start();
    }
}
...
function mainEntrence_random() {
    ...
    commonFunction.enterMainPage(appNameArray[randomNum], waitTime_random);
    ...
    while (true) {
        ...
        moduleNameArray[randomNum].start_random();
